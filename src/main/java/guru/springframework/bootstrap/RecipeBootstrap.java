...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        //log.error("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        //log.error("UOMs: " + unitOfMeasureReactiveRepository.count().block().toString());
        //log.error("Category: " + categoryReactiveRepository.count().block().toString());
        //log.error("Recipe: " + recipeReactiveRepository.count().block().toString());
    }
